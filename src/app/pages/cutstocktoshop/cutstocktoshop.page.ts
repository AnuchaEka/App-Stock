...
@Component({
  ...
  styleUrls: ['./cutstocktoshop.page.scss'],
})
export class CutstocktoshopPage implements OnInit {
  name;
  id
  ...
  this.scanner.scan(this.options).then((data)=>{
    ...
    await this.api.getDataById('cutstock/viewstock',this.id)
      .subscribe(res => {
        //console.log(res);
        this.resdata = res;
        loading.dismiss();
  ...
  getPage(){
    this.router.navigate(['cutstockhistory/'+this.id+'/'+this.name]);
  }
